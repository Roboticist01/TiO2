...
///
/// ```
/// use tio2::translation::tokens::{get_inverse_tokens_as_str, Byte, BYTE_TOKENS};
///
...
/// The [`Byte`] enum represents bytes, which can be either single bytes ([`Byte::Single`]) or
/// two bytes ([`Byte::Double`]).
///
/// # Examples
///
/// ```
